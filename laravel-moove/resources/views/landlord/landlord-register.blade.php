...
@section('title')
<title>moove - register as landlord</title>
@endsection('title')
@section('content')
    ...
    <form action="{{route('landlord.register-submit')}}" method="post">
        ...
        <div class="flex flex-col items-center justify-center">
            <div class="bg-white shadow rounded lg:w-1/3  md:w-1/2 w-full p-10 mt-16">
                <p tabindex="0" class="focus:outline-none text-2xl font-extrabold leading-6 text-gray-800">Welcome Landlord, Create a moove account</p>
                ...
                <div class="mt-8">
                    <button role="button" type="submit" class="focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 text-sm font-semibold leading-none text-white focus:outline-none bg-indigo-700 border rounded hover:bg-indigo-600 py-4 w-full">Create Landlord Account</button>
                </div>
            </div>
        </div>
    </form>
